...
export default function Body() {
    return(
        <div className="text-black bg-white">
            ...
            <Image src={image1} alt="image" width={7000}  className="h-[450px] xl:h-[800px] xl:max-h-[100rem]"/>
            </div>
            <div className="absolute z-10 inset-0 bg-gradient-to-r from-[#071909] to-[#3EA64C00]">
                <div className="xl:w-[60%] mx-5 xl:mx-[5rem] xl:my-[5rem] py-[5rem] onset-0 absolute z-20">
                <div className="z-40 ">
                <p className="text-[1.5rem] text-center xl:text-left xl:text-[3rem] xl:w-[70%] font-bold text-white opacity-100">Design the Future with Product Design</p>
                <p className="text-white text-[0.9rem] xl:w-[80%] font-medium opacity-100">Transform your ideas into impactful digital products with our product design courses. Learn user-centered design principles, wireframing, prototyping, and usability testing to create intuitive and visually stunning products that delight users and drive business success.</p>
                </div>
                <div className="mt-3 flex flex-col xl:flex-row space-y-3">
                    <button className="bg-[#2F7D39] text-white px-4 py-4 rounded-lg">Register Now</button>
                    <button className="text-white bg-transparent px-4 py-3 xl:mx-5 rounded-lg outline-white outline">Read More</button>
                </div>
                </div>
            </div>
            </div>
