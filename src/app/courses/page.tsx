    ...
    return(
        <div className="bg-white text-black">
            ...
            <div className="rounded-3xl relative w-[90%] mx-auto xl:h-[800px] overflow-hidden">
                <Image src={image1} alt="images" className=" rounded-3xl xl:h-[800px]"/>
            ...
            <div className="rounded-3xl relative w-[90%] mx-auto xl:h-[1000px] overflow-hidden mt-10">
                <Image src={image2} alt="image" className=" rounded-3xl xl:h-[1000px]"/>
                <div className="absolute z-10 inset-0 bg-gradient-to-r from-[#00000066] to-[#00000066] rounded-3xl xl:h-[1000px]">
                    <div className="xl:w-[30%] w-[60%] mx-auto h-[200px] xl:mt-[36rem] mt-20 bg-trnsparent">
            ...
            <div className="rounded-3xl relative w-[90%] mx-auto xl:h-[800px] overflow-hidden mt-10">
                <Image src={image3} alt="image" className=" rounded-3xl xl:h-[1000px]"/>
                <div className="absolute z-10 inset-0 bg-gradient-to-r from-[#00000066] to-[#00000066] rounded-3xl xl:h-[1000px]">
                    <div className="xl:w-[30%] w-[60%] mx-auto h-[200px] xl:mt-[36rem] mt-20 bg-trnsparent">
